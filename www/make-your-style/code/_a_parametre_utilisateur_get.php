<?php
    ...
    /* prec_et_suiv */
    if ( $table_a_parametre_utilisateur->mf_compter((isset($est_charge['utilisateur']) ? $mf_contexte['Code_utilisateur'] : 0), (isset($est_charge['parametre']) ? $mf_contexte['Code_parametre'] : 0))<100 )
    {
        $liste_a_parametre_utilisateur = $table_a_parametre_utilisateur->mf_lister_contexte();
        // prec
    ...
    /* Code_utilisateur */
        $trans['{Code_utilisateur}'] = get_valeur_html_maj_auto_interface([ 'liste_valeurs_cle_table' => array('Code_utilisateur'=>$a_parametre_utilisateur['Code_utilisateur'], 'Code_parametre'=>$a_parametre_utilisateur['Code_parametre']) , 'DB_name' => 'Code_utilisateur' , 'valeur_initiale' => $a_parametre_utilisateur['Code_utilisateur'] ]);

    /* Code_parametre */
        $trans['{Code_parametre}'] = get_valeur_html_maj_auto_interface([ 'liste_valeurs_cle_table' => array('Code_utilisateur'=>$a_parametre_utilisateur['Code_utilisateur'], 'Code_parametre'=>$a_parametre_utilisateur['Code_parametre']) , 'DB_name' => 'Code_parametre' , 'valeur_initiale' => $a_parametre_utilisateur['Code_parametre'] ]);

    /* a_parametre_utilisateur_Valeur */
        if ( $mf_droits_defaut['api_modifier__a_parametre_utilisateur_Valeur'] )
            $trans['{a_parametre_utilisateur_Valeur}'] = ajouter_champ_modifiable_interface([ 'liste_valeurs_cle_table' => array('Code_utilisateur'=>$a_parametre_utilisateur['Code_utilisateur'], 'Code_parametre'=>$a_parametre_utilisateur['Code_parametre']) , 'DB_name' => 'a_parametre_utilisateur_Valeur' , 'valeur_initiale' => $a_parametre_utilisateur['a_parametre_utilisateur_Valeur'] ]);
        else
            $trans['{a_parametre_utilisateur_Valeur}'] = get_valeur_html_maj_auto_interface([ 'liste_valeurs_cle_table' => array('Code_utilisateur'=>$a_parametre_utilisateur['Code_utilisateur'], 'Code_parametre'=>$a_parametre_utilisateur['Code_parametre']) , 'DB_name' => 'a_parametre_utilisateur_Valeur' , 'valeur_initiale' => $a_parametre_utilisateur['a_parametre_utilisateur_Valeur'] ]);

    /* a_parametre_utilisateur_Actif */
        if ( $mf_droits_defaut['api_modifier__a_parametre_utilisateur_Actif'] )
            $trans['{a_parametre_utilisateur_Actif}'] = ajouter_champ_modifiable_interface([ 'liste_valeurs_cle_table' => array('Code_utilisateur'=>$a_parametre_utilisateur['Code_utilisateur'], 'Code_parametre'=>$a_parametre_utilisateur['Code_parametre']) , 'DB_name' => 'a_parametre_utilisateur_Actif' , 'valeur_initiale' => $a_parametre_utilisateur['a_parametre_utilisateur_Actif'] ]);
        else
            $trans['{a_parametre_utilisateur_Actif}'] = get_valeur_html_maj_auto_interface([ 'liste_valeurs_cle_table' => array('Code_utilisateur'=>$a_parametre_utilisateur['Code_utilisateur'], 'Code_parametre'=>$a_parametre_utilisateur['Code_parametre']) , 'DB_name' => 'a_parametre_utilisateur_Actif' , 'valeur_initiale' => $a_parametre_utilisateur['a_parametre_utilisateur_Actif'] ]);
