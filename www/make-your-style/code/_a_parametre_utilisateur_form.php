<?php declare(strict_types=1);
    ...
    if ($mf_action == 'apercu_a_parametre_utilisateur' && $_GET['act'] != 'ajouter_a_parametre_utilisateur' && $_GET['act'] != 'supprimer_a_parametre_utilisateur') {
        ...
        if (isset($Code_utilisateur) && $Code_utilisateur!=0 && isset($Code_parametre) && $Code_parametre!=0) {
            $a_parametre_utilisateur = $db->a_parametre_utilisateur()->mf_get(mf_Code_utilisateur(), mf_Code_parametre(), ['autocompletion' => true]);
        }
    ...
    if ($mf_action == "ajouter_a_parametre_utilisateur") {
        ...
        {
            $form->ajouter_select(lister_cles($lang_standard['Code_parametre_']), "Code_parametre", ( isset($_POST['Code_parametre']) ? (int) $_POST['Code_parametre'] : 0 ), true);
        }
        ...
        $code_html .= recuperer_gabarit('a_parametre_utilisateur/form_add_a_parametre_utilisateur.html', ['{form}' => $form->generer_code(), '{title}' => get_nom_colonne('form_add_a_parametre_utilisateur')], false, true);
        ...
        if (isset($a_parametre_utilisateur['Code_utilisateur']))
        {
            ...
            $code_html .= recuperer_gabarit('a_parametre_utilisateur/form_edit_a_parametre_utilisateur.html', ['{form}' => $form->generer_code(), '{title}' => get_nom_colonne('form_edit_a_parametre_utilisateur')], false, true);
    ...
    } elseif ($mf_action=='modifier_a_parametre_utilisateur_Valeur')
    {
        ...
        if (isset($a_parametre_utilisateur['Code_utilisateur']))
        {
            ...
            $code_html .= recuperer_gabarit('a_parametre_utilisateur/form_edit_a_parametre_utilisateur_Valeur.html', ['{form}' => $form->generer_code(), '{title}' => get_nom_colonne('form_edit_a_parametre_utilisateur_Valeur')], false, true);
    ...
    } elseif ($mf_action=='modifier_a_parametre_utilisateur_Actif')
    {
        ...
        if (isset($a_parametre_utilisateur['Code_utilisateur']))
        {
            ...
            $code_html .= recuperer_gabarit('a_parametre_utilisateur/form_edit_a_parametre_utilisateur_Actif.html', ['{form}' => $form->generer_code(), '{title}' => get_nom_colonne('form_edit_a_parametre_utilisateur_Actif')], false, true);
    ...
    } elseif ($mf_action=="supprimer_a_parametre_utilisateur")
    {
        ...
        if ( isset($a_parametre_utilisateur['Code_utilisateur']) )
        {
            ...
            $code_html .= recuperer_gabarit('a_parametre_utilisateur/form_delete_a_parametre_utilisateur.html', ['{form}' => $form->generer_code(), '{title}' => get_nom_colonne('form_delete_a_parametre_utilisateur')], false, true);
