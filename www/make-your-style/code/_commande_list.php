<?php
    ...
    // liste
        ...
        $trans['{tableau_commande}']=$tab->generer_code();

    // boutons
        if ($mf_droits_defaut['commande__AJOUTER'])
        {
            $menu_a_droite->ajouter_bouton( BOUTON_LIBELLE_AJOUTER_PREC . get_nom_colonne('bouton_ajouter_commande') . BOUTON_LIBELLE_AJOUTER_SUIV, get_nom_page_courante().'?act=ajouter_commande&Code_utilisateur='.$Code_utilisateur.'', 'lien', 'bouton_ajouter_commande');
        }
        ...
        {
            $menu_a_droite->ajouter_bouton( BOUTON_LIBELLE_AJOUTER_PREC . get_nom_colonne('bouton_creer_commande') . BOUTON_LIBELLE_AJOUTER_SUIV, get_nom_page_courante().'?act=creer_commande&Code_utilisateur='.$Code_utilisateur.'', 'lien', 'bouton_creer_commande');
        }
