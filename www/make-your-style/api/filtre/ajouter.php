<?php
    ...
    if (API_REST_ACCESS_POST_FILTRE == 'all') {
...
/*
    ...
    +-----------+
*/
    $filtre_Libelle = lecture_parametre_api("filtre_Libelle", '');
    $retour = $table_filtre->mf_ajouter($filtre_Libelle);
    ...
    $retour_json['Code_filtre'] = $retour['Code_filtre'];
