<?php
    ...
    if (API_REST_ACCESS_POST_A_FILTRE_PRODUIT == 'all') {
...
*/
    ...
    $a_filtre_produit_Actif = lecture_parametre_api("a_filtre_produit_Actif", '');
    $retour = $table_a_filtre_produit->mf_ajouter($Code_filtre, $Code_article, $a_filtre_produit_Actif);
